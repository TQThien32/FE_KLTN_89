                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <col-lg-6>
                                    <p class="text-center"><b>
                                            <h5 class="mb-0">Cơ Quan Xác Thực</h5>
                                        </b></p>
                                </col-lg-6>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                    <h6 class="mb-0">Tên Cơ Quan</h6>
                                </div>
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="capnhat" tabindex="-1" aria-labelledby="exampleModalLabel"
                                aria-hidden="true">
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="doimatkhau" tabindex="-1" aria-labelledby="exampleModalLabel"
                                aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-sm-3">
                                                    <h6 class="mb-0">Nhập Mật Khẩu Mới</h6>
                                                </div>
                                                <div class="col-sm-9 text-secondary">
