                        ...
                        <template v-for="(value, index) in list_hoc_vien" :key="index">
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <img v-bind:src="value.hinh_anh ? value.hinh_anh : 'https://www.svgrepo.com/show/384670/account-avatar-profile-user.svg'" alt=""
                                        style="width: 50px; height: 50px; border-radius: 50%;">
                                </td>
                                <td class="align-middle text-center">
                                    <button v-on:click="doiTrangThai(value)" v-if="value.is_duyet == 1"
                                        class="btn btn-success">Đã Duyệt</button>
                                    <button v-on:click="doiTrangThai(value)" v-else-if="value.is_duyet == 2" class="btn btn-warning">Bị Khoá</button>
                                    <button v-on:click="doiTrangThai(value)" v-else class="btn btn-danger">Chưa Duyệt</button>
                                </td>
                            </tr>
                        </template>
                    </tbody>
