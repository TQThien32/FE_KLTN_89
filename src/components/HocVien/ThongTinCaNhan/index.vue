              ...
              <div class="col-lg-4">
                <div class="card">
                  <div class="card-body text-center">
                    <img src="assets/images/avatars/avatar-2.png" alt="Avatar" class="rounded-circle p-1 bg-primary" width="110">
                    <div class="mt-3">
                      <h4>John Doe</h4>
              ...
              <div class="col-lg-8">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row mb-3">
                      <div class="col-sm-3"><h6 class="mb-0">Giới Tính</h6></div>
                      <div class="col-sm-9 text-secondary">
                    ...
                    <div class="row mb-3">
                      <div class="col-sm-3"><h6 class="mb-0">Số CCCD</h6></div>
                      <div class="col-sm-9 text-secondary">
