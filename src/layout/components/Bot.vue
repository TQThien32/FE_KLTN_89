        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-12 col-12">
                    <div class="row">
                        <div class="col-sm-6 col-lg-7 col-12 footer-nav-logo widget text-light mt-3">
                            <a href="/" class="logo-wrapper" title="Evo Tools">
                                <div class="d-flex justify-content-start">
                                    <img src="https://cdn-icons-png.freepik.com/256/8523/8523899.png?ga=GA1.1.1642455953.1744362054&semt=ais_hybri"
                                        style="height: 50px; width: 50px;" alt="Evo Tools" class="lazy loaded me-2"
                ...
                <div class="col-lg-5 col-md-12 col-12 fix-ipad-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-6 col-6 footer-nav-menu widget mt-3">
                            <button class="btn btn-outline-light me-2"><i
                                    class="fa-brands fa-facebook ms-1"></i></button>
                            <button class="btn btn-outline-light me-2"><i
                                    class="fa-brands fa-instagram ms-1"></i></button>
